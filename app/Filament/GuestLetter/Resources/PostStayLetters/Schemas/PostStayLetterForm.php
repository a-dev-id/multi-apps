...
namespace App\Filament\GuestLetter\Resources\PostStayLetters\Schemas;
    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Select::make('guest_id')
                ...
                ->options(
                    Guest::query()
                        ->whereDoesntHave('guestLetterSends', function ($query) {
                            $query->where('type', 'post_stay')
